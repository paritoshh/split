...
function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-dark-300">
      {/* Mobile Header */}
      <header className="lg:hidden flex items-center justify-between p-4 bg-dark-200 border-b border-gray-800">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          />
          <aside className="absolute left-0 top-0 bottom-0 w-72 bg-dark-200 p-6 animate-slide-right">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <Link
                to="/profile"
                onClick={() => setSidebarOpen(false)}
                className="flex items-center gap-3 p-4 rounded-xl bg-dark-100 mb-4 hover:bg-dark-300 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-gray-400 hover:bg-dark-100 hover:text-red-400 transition-all"
              >
